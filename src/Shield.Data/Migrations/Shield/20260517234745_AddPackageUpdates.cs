        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentVersion = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    LatestVersion = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    ...
                    AppliedPullRequestUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
